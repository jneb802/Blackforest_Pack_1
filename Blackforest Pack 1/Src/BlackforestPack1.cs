...
namespace Blackforest_Pack_1
{
    ...
    {
        internal const string ModName = "Blackforest_Pack_1";
        ...
        public static readonly ManualLogSource Blackforest_Pack_1Logger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                Blackforest_Pack_1Logger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                Blackforest_Pack_1Logger.LogError($"There was an issue loading your {ConfigFileName}");
                Blackforest_Pack_1Logger.LogError("Please check your config entries for spelling and format!");
            }
        }
